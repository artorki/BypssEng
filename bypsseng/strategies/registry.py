...
def get_strategy(creds, all_configs=None, dpi_state='none', local_socks_port=None, local_http_port=None, data_dir=None, binary_paths=None):
    ...
    if proto in ("vless", "trojan", "vmess", "ss", "shadowtls", "warp", "warp_over_reality", "cloudflare_worker"):
        ...
        return HysteriaStrategy(creds, all_configs, dpi_state, local_socks_port, local_http_port, data_dir, binary_paths)
    elif proto == "tuic":
        return TuicStrategy(creds, all_configs, dpi_state, local_socks_port, local_http_port, data_dir, binary_paths)
    elif proto in ("naive+https", "naive"):
        return NaiveStrategy(creds, all_configs, dpi_state, local_socks_port, local_http_port, data_dir, binary_paths)
