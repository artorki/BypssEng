...
class HysteriaStrategy(Strategy):
    ...
    async def prepare(self):
        ...
        if creds["hysteria_obfs"]:
            ...
            if creds["hysteria_obfs"] == "salamander": config["obfs"]["salamander"] = {"password": creds["hysteria_obfs_password"]}
        atomic_write_json(os.path.join(self.data_dir, "auto_bypass_config_hy2.json"), config)
